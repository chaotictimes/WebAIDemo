...
<head>
    ...
    <script type="text/javascript">
		$(function(){
			var baseImageFile = "/statics/sourceimage/xianchang.jpg"
			var newImageFile = "/statics/destimage/xianchang.jpg"
			$("#oldimg").attr("src",baseUrl+baseImageFile);
			$("#oldimg").attr("resrc",baseImageFile);
			$("#oldimg").attr("style","width:100%;");
			
			//识别
			$("#detectExcavator").click(function(){
				...
				$.SaveForm({
					url : ctxPath+"/demo/detectExcavator?_" + $.now(),
					param: {"url":url},
					json:true,
			...
			$("#upload").change(function(){
			    ...
			    $.ajax({
			        url:ctxPath+"/demo/doSaveFile?suffixName=" + "_excavator",
			        dataType:'json',
			        type:'POST',
			        async: false,
			        data: formData,
...
<h3>
     挖掘机识别demo
     		...
     		<div class="row">
     			...
     			<div class="col-sm-6">
			    	<a class="btn btn-info"  id="detectExcavator" style="margin:0px 0px 10px 0px;"><i class="fa fa-object-ungroup" ></i>识别</a>
			    </div>
			</div>
