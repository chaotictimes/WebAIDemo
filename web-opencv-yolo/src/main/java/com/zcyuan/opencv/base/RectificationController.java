...
public class RectificationController extends BaseController {
	...
	public void rectification(HttpServletResponse response, String imagefile, Integer markType) {
		...
		// 加载为灰度图显示
		Mat source1 = Imgcodecs.imread(sourcePath, Imgcodecs.CV_LOAD_IMAGE_COLOR);
		Mat source2 = Imgcodecs.imread(sourcePath, Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
	...
	public static void fetchAnchorPoints1(String sourcePath, String matchPath, Point anchor01, Point anchor02,
		...
		Mat colorimage = Imgcodecs.imread(sourcePath, Imgcodecs.CV_LOAD_IMAGE_COLOR);
		...
		// Imgcodecs.imwrite("D://ttt/t1.jpg", src01);
		// Imgcodecs.imwrite("D://ttt/t2.jpg", src02);
		// Imgcodecs.imwrite("D://ttt/t3.jpg", src03);
		// Imgcodecs.imwrite("D://ttt/t4.jpg", src04);
		Mat mattmp = Imgcodecs.imread(matchPath, Imgcodecs.CV_LOAD_IMAGE_COLOR);
	...
	public static void fetchAnchorPoints2(String sourcePath, Point anchor01, Point anchor02, Point anchor03,
			Point anchor04) {
		Mat src = Imgcodecs.imread(sourcePath, Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
		Mat colorimage = Imgcodecs.imread(sourcePath, Imgcodecs.CV_LOAD_IMAGE_COLOR);
