 ...
 */
package com.zcyuan.opencv.common.web;
...
import com.zcyuan.opencv.common.mapper.JsonMapper;
...
public abstract class BaseController{
	...
	protected void renderImage(HttpServletResponse response, byte[] object) {
		try {
			...
			output.close();
			// ServletOutputStream output = response.getOutputStream();
			// FileInputStream fis = new FileInputStream("E:\\tomcat7\\webapps\\web_opencv\\statics\\distimage\\lena.png");
	...
	protected Map<String ,String> postDataMap(HttpServletRequest request) throws IOException{
		String jsonString = getJsonString(request);
		System.out.println("===========postDataMap:" + jsonString);
		String str = java.net.URLDecoder.decode(jsonString);
		return json.fromJson(str, new TypeToken<Map<String, ?>>(){}.getType());
