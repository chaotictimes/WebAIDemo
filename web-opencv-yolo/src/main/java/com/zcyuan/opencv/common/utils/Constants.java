package com.zcyuan.opencv.common.utils;
...
public class Constants {
	 ...
	 * 文件
	 */
	public static final String UPLOAD_IMAGE_PATH = Constants.SF_FILE_SEPARATOR + "statics" + Constants.SF_FILE_SEPARATOR
			+ "sourceimage" + Constants.SF_FILE_SEPARATOR + "upload" + Constants.SF_FILE_SEPARATOR;
